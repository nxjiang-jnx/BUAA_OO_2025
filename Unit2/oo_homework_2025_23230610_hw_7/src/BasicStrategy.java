...
public class BasicStrategy implements Strategy {
    ...
    public Status decideStatus(String currentFloor, String direction, int currentPeopleCount,
        ...
        boolean hasSche = !requestTable.isScheRequestEmpty();

        boolean hasUpdate = !requestTable.isUpdateRequestEmpty();
        ...
        if (hasSche) {
            ...
            return Status.OPEN;
        } else if (currentPeopleCount == 0 && requestTable.isPersonRequestEmpty()
            && requestTable.isEnd()) {
            return Status.END;
        } else if (currentPeopleCount == 0 && requestTable.isPersonRequestEmpty()
            && !requestTable.isEnd()) {
